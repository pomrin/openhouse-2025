...
function UserLanding() {
  ...
  //set const
  const [ticket_id, setUniqueId] = useState(
    () => localStorage.getItem("ticket_id") || ""
  ); // Load from local storage // State for ticket ID
  ...
  const handleIncrementQueue = () => {
    setQueueNumber((prevQueueNumber) => {
      const nextQueueNumber = (parseInt(prevQueueNumber) + 1)
        .toString()
        .padStart(4, "0");
      ...
      <Box className="bodyBox">
        ...
        <Box>
          ...
          <div onMouseEnter={onHover} onMouseLeave={onLeave}>
            <h3>
              Upload your photo now and join us as we aim to set a Singapore
              Book of Records title for 'Most People Contributing to a Digital
              Avatar Montage.'
            </h3>
          </div>
          <br />
